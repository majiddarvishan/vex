// ============================================================================
// RAII wrappers for automatic metric cleanup
// ============================================================================
#pragma once
...
class ScopedCounter {
public:
    ScopedCounter(prometheus::Family<prometheus::Counter>& family,
    ...
    prometheus::Counter& operator*() { return *metric_; }
    prometheus::Counter* operator->() { return metric_; }
    prometheus::Counter* get() { return metric_; }
...
class ScopedGauge {
public:
    ScopedGauge(prometheus::Family<prometheus::Gauge>& family,
                const std::map<std::string, std::string>& labels);
    ~ScopedGauge();
    ...
    prometheus::Gauge& operator*() { return *metric_; }
    prometheus::Gauge* operator->() { return metric_; }
    prometheus::Gauge* get() { return metric_; }
