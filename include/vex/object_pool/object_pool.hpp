...
#include <vex/object_pool/internal/prometheus_metrics.hpp>
...
namespace vex
{
    ...
    public:
        ...
        std::shared_ptr<T> create(Args&&... args)
        {
            ...
            // create shared_ptr with safe deleter that captures a weak_ptr to
            // this pool
    ...
    private:
        ...
        void release(void* obj)
        {
            ...
            else
            {
                ...
                std::cerr << "ObjectPool::release(): subpool lost; deleting "
                             "object\n";
                delete static_cast<char*>(obj
                ); // fallback - but better to delete with proper type, we can't
            }
        }
